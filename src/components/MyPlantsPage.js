  ...
  return (
    <div className="flex flex-row p-2 w-full h-screen bg-[#eff0ec]">
      <div class="flex flex-col w-full">
                {addingNote ? (
                  <div class="overflow-x-auto scrollable-area">
                      <div class="flex flex-row">
                        <NewPlantCard info={{ type: "Basil"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Snake Plant"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Golden Pathos"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Aloe Vera"}} ></NewPlantCard>
                      </div>
                      <div class="flex flex-row">
                        <NewPlantCard info={{ type: "Spider Plant"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Peace Lily"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Moth Orchid"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Marble Pothos"}} ></NewPlantCard>
                      </div>
                      <div class="flex flex-row">
                        <NewPlantCard info={{ type: "Echeveria"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Red Prayer Plant"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Garden Corton"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Lavendar"}} ></NewPlantCard>
                      </div>
                      <div class="flex flex-row">
                        <NewPlantCard info={{ type: "Echeveria"}} ></NewPlantCard>
                        <NewPlantCard info={{ type: "Red Prayer Plant"}} ></NewPlantCard>
                        ...
                        <div class="flex flex-row w-full h-full justify-center items-center bg-white rounded-md p-2">
                              ...
                              >
                                <div className="flex flex-row items-center w-full h-full p-4">
                                  ...
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M29.1661 12.5H20.8327V22.2224H11.1094L11.1094 30.5557H20.8327V38.8889H29.1661V30.5557H38.8872V22.2224H29.1661V12.5Z"/>
                                  </mask>
